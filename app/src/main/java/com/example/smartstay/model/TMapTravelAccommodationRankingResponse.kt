...
data class TMapTravelAccommodationRankingResponse(
    val status: CommonStatus,
    val contents: AccommodationRankingContents // 숙소 순위 정보 객체
)

data class AccommodationRankingContents(
    val poiId: String, // 순위를 조회한 숙소의 코드
    val poiName: String, // 숙소명
    val category: String, // 숙소 분류 ex) 3성급
    val lat: Float, // 위도
    val lng: Float, // 경도
    val stat: Stat, // 숙소 순위 정보 객체
