    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        when (progress) {
                    ...
                    4 -> {
                        ...
                        cvOption1.setOnClickListener {
                            if (!cvOption1.isSelected) {
                                cvOption1.isSelected = true
                                cvOption2.isSelected = false
                                viewModel.userInitialInfoMap["marriage_status"] =
                                    Constants.MARRIAGE_MARRIED
                            }
                        }
                        cvOption2.setOnClickListener {
                            if (!cvOption2.isSelected) {
                    ...
                    5 -> {
                        ...
                        cvOption1.setOnClickListener {
                            if (!cvOption1.isSelected) {
                                cvOption1.isSelected = true
                                cvOption2.isSelected = false
                                viewModel.userInitialInfoMap["children_status"] =
                                    Constants.HAS_CHILDREN
                            }
                        }
                        cvOption2.setOnClickListener {
                            if (!cvOption2.isSelected) {
                    ...
                    7 -> {
                        ...
                        cvOption1.setOnClickListener {
                            if (!cvOption1.isSelected) {
                                cvOption1.isSelected = true
                                cvOption2.isSelected = false
                                viewModel.userInitialInfoMap["companion_status"] =
                                    Constants.HAS_COMPANION
                            }
                        }
                        cvOption2.setOnClickListener {
                            if (!cvOption2.isSelected) {
            ...
            3 -> {
                ...
                inflatedView.findViewById<MaterialCardView>(R.id.cv_multiple_option_15).visibility =
                    View.INVISIBLE // chain 때문에 놔둠 (refactoring)
                    ...
                    6 -> {
                        ...
                        slider.apply {
                            ...
                            addOnSliderTouchListener(object : Slider.OnSliderTouchListener {
                                override fun onStartTrackingTouch(slider: Slider) = Unit
                                override fun onStopTrackingTouch(slider: Slider) {
                                    viewModel.userInitialInfoMap["family_count"] =
                                        slider.value.toInt()
                                }
